...
echo "$(date +"%D %T"): parsing arguments:  $1"
	case "$1" in
...
echo "$(date +"%D %T"): REF_TRANSCRIPT_LOC is  $REF_TRANSCRIPT_LOC"
echo "$(date +"%D %T"): TRANSCRIPT_LOCS is  ${TRANSCRIPT_LOCS[@]}"
echo "$(date +"%D %T"): REF_GENOME_LOC is  $REF_GENOME_LOC"
